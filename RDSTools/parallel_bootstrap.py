...
def RDSBootOptimizedParallel(data, respondent_id_col, seed_id_col, seed_col, recruiter_id_col, type, resample_n,
                             n_cores=2):
    """
    Parallelized Bootstrap Resampling for Respondent Driven Sampling (RDS)

    This function performs resampling RDS sample data by bootstrapping edges in recruitment trees or bootstrapping
    recruitment chains as a whole with parallel processing.
    ...
    resample_n : int
        Specifies the number of resamples.
